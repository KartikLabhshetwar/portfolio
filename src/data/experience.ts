    ...
    positions: [
      {
        ...
        summary: 'I build SDKs and editor integrations, improve memory search, and harden the self-hosted server.',
...
- Built CLI import/event commands, restructured the monorepo (plugins consolidated under integrations/), and led the v3 API docs migration, authoring SECURITY.md, integration guides (Google ADK, ChatDev, Hermes), and coordinated SDK releases (Python 2.0.x, TS 3.0.x).`,
      },
      {
        ...
        summary: 'I fixed SDK bugs, built the TypeScript test suite, and helped maintain the open-source project.',
...
- Reviewed 47 community PRs with detailed line-level feedback, guiding MiniMax LLM, Apache AGE graph store, and REST server auth to merge-ready quality.
    ...
    positions: [
      {
        ...
        summary: 'I built reminders, messaging integrations, and product features for an AI assistant.',
        employmentType: 'Internship',
